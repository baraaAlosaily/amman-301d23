...
// this in this case refers to student object instant of joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// this in this case refers to window property of the browser
// 3. Explain why "this" is different when an arrow function is used.
// ‘this’ refers to it’s current surrounding scope and no further. Thus the inner function knew to bind to the inner function only, and not to the object’s method or the object itself.
